...
public class ShoppingTest extends TestBase {
    ...
    public void verifyThatUserShouldPlaceOrderSuccessfullyForOllieTheAppControlledRobot() throws InterruptedException {
        ...
        secureCheckOut.firstNameField("Umi");
        secureCheckOut.lastNameField("Patel");
        secureCheckOut.addressField("14 Queen Road");
        secureCheckOut.stateField("England");
        Thread.sleep(500);
        secureCheckOut.clickOnCreateAccountCheckBox();
        //1.19 Enter the password
        secureCheckOut.passwordField("umi123");
        Thread.sleep(5000);
